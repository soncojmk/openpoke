...
class Settings(BaseModel):
    ...
    # LLM model selection
    interaction_agent_model: str = Field(default="anthropic/claude-haiku-4.5")
    ...
    summarizer_model: str = Field(default="anthropic/claude-haiku-4.5")
    email_classifier_model: str = Field(default="anthropic/claude-haiku-4.5")
